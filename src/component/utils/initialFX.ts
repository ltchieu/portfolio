...
function LoopText(Text1: TextSplitter, Text2: TextSplitter) {
  ...
  // Initially ensure Text2 chars are hidden and offset
  gsap.set(Text2.chars, { opacity: 0, y: 80 });

  // 1. After 4s delay, slide Text1 up and slide Text2 in
  tl.to(
    Text1.chars,
    {
      y: -80,
  ...
  // 2. After another 4s, slide Text2 up and slide Text1 back in
  tl.to(
    Text2.chars,
    {
      y: -80,
